...
#     3   3 3   3
# =============================================================================
def polno_drevo_globin(n):
    d = Drevo()
    if n == 0:
        return Drevo()
    else:
        levo_d = polno_drevo_globin(n-1)
        desno_d = polno_drevo_globin(n-1)
        return Drevo(n, levo=levo_d, desno=desno_d)
# =====================================================================@038459=
# 4. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ1NiwidXNlciI6NjQ4M30:1rBcwZ:m4phJPh_8PvMCRlV3N54YSmz8Mb9ioIHiigDgrUk2sc"
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ1NywidXNlciI6NjQ4M30:1rBcwZ:1qDLvY5CefEqGELYEJEs63mIl__QXM7nctnyBe5T4qA"
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ1OCwidXNlciI6NjQ4M30:1rBcwZ:MoecarUXlkfL6t829xNqcBvt8BacTUUCkst5eXJKQv4"
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ1OSwidXNlciI6NjQ4M30:1rBcwZ:efiBgbRYJ57laOd8ALLu7RSnc1xvx5NCe_on8M8_ayU"
        try:
            tests = [
                ('drevo_vsot([])', Drevo()),
