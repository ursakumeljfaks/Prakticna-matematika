...
# =============================================================================
class Drevo:
    def __init__(self, podatek, levo=None, desno=None):
        self._koren = podatek

    
    
    def prazno(self):
        return self.levo is None and self.desno is None and self._koren is None
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ1MSwidXNlciI6NjQ4M30:1rBbbm:LhhJcdlnOCdK9lPmolffSsUZJLu6r4U3qLAomAWPFh8"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ1MiwidXNlciI6NjQ4M30:1rBbbm:vWjZoZWyFuFg127Hx2fNzK5I1XjMbqu2aF0WIqSkpYg"
        try:
