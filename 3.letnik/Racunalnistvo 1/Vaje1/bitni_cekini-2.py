...
def prenesi(racun1, racun2, koliko):
    if (racun1._stanje - koliko) < 0:
        return False
    else:
        racun1._stanje -= koliko
        racun2._stanje += koliko
        return True
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODIzMSwidXNlciI6NjQ4M30:1qrhJx:uBVd6YMBxheKwGKn9j8aoq5ND6QMIfrAfqDp5QfIosI"
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODIzMiwidXNlciI6NjQ4M30:1qrhJx:xnvvmAJ_4tjqrsxM0_P8bscqiP37UmjlGtP6HSErVok"
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODIzMywidXNlciI6NjQ4M30:1qrhJx:ICpTuoRr6DJNkoZipNlL-jBnIHWzRYqz5i4zqjso0gw"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODIzNCwidXNlciI6NjQ4M30:1qrhJx:cNLDXmjRkmR8ibBWeeo11eLiqCL9gDfWQkEWD-Yf4nk"
        try:
