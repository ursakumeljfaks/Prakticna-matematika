...
class NeusmerjenGraf:
    def __init__(self, seznam_povezav):
        vrednosti = set()
        slovar = dict()
        for (i1, i2) in seznam_povezav:
            if i1 and i2 not in vrednosti:
                slovar[i1] = i2
                slovar[i2] = i1
            else:
                slovar[i1] = vrednosti.add(i2)
                slovar[i2] = vrednosti.add(i1)
        self.sosedje = slovar
# =====================================================================@038226=
# 2. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODIyNSwidXNlciI6NjQ4M30:1qrGsb:ui7_27_1UWPfsncHBcDka9ua31xYYseiAnzZQr7TKQ8"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODIyNiwidXNlciI6NjQ4M30:1qrGsb:W3Z2XKIsfD0qaCN4DXJzJeTwBTGgf7W1g2zJG8u95gU"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODIyNywidXNlciI6NjQ4M30:1qrGsb:Ptodh3KWPdJJSleCN6iSVFPZhWoF8LepkVzwupt27Jc"
        try:
            test_data = [
                (["g = NeusmerjenGraf([(1, 2), (2, 3), (3, 1)])",
                  "g.dodaj_vozlisce(4)",
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODIyOCwidXNlciI6NjQ4M30:1qrGsb:iDzAHXdsTiTlRnvNHftSMAMG17YM6dmJPL2FNEbxmPE"
        try:
            test_data = [
                (["g = NeusmerjenGraf([(1, 2), (2, 3), (3, 1)])",
                  "g.odstrani_vozlisce(3)",
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODIyOSwidXNlciI6NjQ4M30:1qrGsb:HGTvm53XwKVzmkjNE6Pd1jemI04wDbeOO2QrsCq8g-Y"
        try:
            test_data = [
                (["g = NeusmerjenGraf([(1, 2), (2, 3), (3, 1)])",
                  "g.dodaj_povezavo((1, 4))",
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODIzMCwidXNlciI6NjQ4M30:1qrGsb:wQEx2ZQOwwR2A6VR6A8KOdXQ5GP2nwYhHF6jaUlvxvI"
        try:
            test_data = [
                (["g = NeusmerjenGraf([(1, 2), (2, 3), (3, 1)])",
                  "g.odstrani_povezavo((1, 2))",
