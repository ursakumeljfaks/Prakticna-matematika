...
def teza_kosila(starost, teza):
    """vrne tezo kosila za studenta"""
    za_40 = 6.5 + 40 * 0.1
    minus_g = za_40 - starost * 0.1
    return teza * minus_g
# =====================================================================@028109=
# 2. podnaloga
...
#          1, 4
# =============================================================================
def delitev_kruha(kosi_kruha, studenti):
    """izracuna koliko kosov kruha dobi vsak student in koliko kosov ostane"""
    kruh_na_studenta = kosi_kruha // studenti
    ostanek = kosi_kruha - studenti * kruh_na_studenta
    return kruh_na_studenta, ostanek
# =====================================================================@028110=
# 3. podnaloga
...
# =============================================================================
def kolicina_kruha(st_studentov, kosov_na_ucenca, kosov_na_struco):
    """vrne vsoto struc, ki jo morajo kupiti"""
    vsi_kosi_kruha = st_studentov * kosov_na_ucenca
    koliko_struc = vsi_kosi_kruha // kosov_na_struco
    return koliko_struc + 1
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2NDgzLCJwYXJ0IjoyODEwOH0:1mxbtV:KVi5Z7tsDb5G9BXpW2TlzdL4igY'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2NDgzLCJwYXJ0IjoyODEwOX0:1mxbtV:U3EPIloPWl5iF6xFPANMtnsydIk'
        try:
            s = Check.current_part['solution']
            sw = re.sub('[ \n]', '', s)
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2NDgzLCJwYXJ0IjoyODExMH0:1mxbtV:vkLLNGmMMfiuhgfRCP_vcVKgJRg'
        try:
            s = Check.current_part['solution']
            sw = re.sub('[ \n]', '', s)
