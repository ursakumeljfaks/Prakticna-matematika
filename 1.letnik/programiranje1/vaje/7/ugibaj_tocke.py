...
def relacija(racunalnik, miha):
    """vrne ali je miha uganil pravilno stevilo"""
    if racunalnik > miha:
        return 'premalo'
    elif racunalnik < miha:
        return 'preveč'
    else:
        return 'Bravo!'
# =====================================================================@028206=
...
def ugibaj(racunalnikX, racunalnikY, mihaX, mihaY):
    """vrne niz koliko je miha oddaljen od tocke"""
    evklidska_razdalja = math.sqrt((mihaX - racunalnikX) ** 2 + (mihaY - racunalnikY) ** 2)
    if mihaX == racunalnikX and mihaY == racunalnikY:
        return "Bravo!"
    else:
        return f'Od prave točke si oddaljen vsaj {int(evklidska_razdalja)}.'
# =====================================================================@028207=
# 3. podnaloga
...
def ugibaj1(racunalnikX, racunalnikY, mihaX, mihaY):
    """vrne v katerem kvadrantu je tocka"""
    evklidska_razdalja = math.sqrt((mihaX - racunalnikX) ** 2 + (mihaY - racunalnikY) ** 2)
    if evklidska_razdalja == 0:
        return "Bravo!"
    else:
        kvadrant = 0
        if mihaX > racunalnikX and mihaY >= racunalnikY:
            ...
            kvadrant = 3
        return f"Tvoja točka je v {kvadrant}. kvadrantu."
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2NDgzLCJwYXJ0IjoyODIwNX0:1mxbw7:JEHQ2py2oEWTBYNmv_ypsdpWlA4'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2NDgzLCJwYXJ0IjoyODIwNn0:1mxbw7:MjqvUURse9R4v_SfwQYynisuE5I'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2NDgzLCJwYXJ0IjoyODIwN30:1mxbw7:mI_qOCpJ5dr9MJUmDeywDpnPwmk'
        try:
            Check.equal("ugibaj1(15, 15, 16, 16)", "Tvoja točka je v 1. kvadrantu.") and \
            Check.equal("ugibaj1(15, 16, 15, 16)", "Bravo!") and \
