...
# =============================================================================
def gcd(m, n):
    """izracuna najvecji skupni delitelj stevil m in n"""
    if m == n == 0:
        return None
    k = n % m
    if k == 0:
...
# =============================================================================
def cantor(n):
    """vrne niz dolzine 3^n z n-tim priblizkom"""
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyODMzMiwidXNlciI6NjQ4M30:1nNHCU:wbKM9TlHjlfjr8tpNEa_X2auTWw'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyODMzMywidXNlciI6NjQ4M30:1nNHCU:WrhRI6lSi1CrdZ-XEx_yeii8R9g'
        try:
            sol = Check.current_part['solution']
            if 'while ' in sol or 'for ' in sol:
                Check.error('Rekli smo brez zank!')
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyODMzNCwidXNlciI6NjQ4M30:1nNHCU:YKqK9uPWn18pVKQ56LIzY2yQCQQ'
        try:
            sol = Check.current_part['solution']
            if 'while ' in sol or 'for ' in sol:
                Check.error('Rekli smo brez zank!')
