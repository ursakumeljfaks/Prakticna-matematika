...
a = 42 + n
print("Za 42 povečano število ", n, " je ", a, ".", sep="")
# =====================================================================@028051=
# 2. podnaloga
...
# =============================================================================
x = int(input("Vpiši poljubno celo število: "))
b = x - 20
print("Za 20 zmanjšano število ", x, " je ", b, ".", sep="")
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2NDgzLCJwYXJ0IjoyODA1MH0:1mxbqf:MNAJU77gelmpSNez0nqeNeCzz2s'
        try:
            vhod = ['9', '123', '0', '-10']
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2NDgzLCJwYXJ0IjoyODA1MX0:1mxbqf:nnTN9RJnDEBgsKHTKQ11YM-9IZc'
        try:
            vhod = ['29', '123', '5', '-10']
