...
#
# V tej nalogi bo že podana koda, zapisana s klasično zanko for. To zanko 
# nadomestite z izpeljano tabelo. Poleg pravilnosti testi preverjajo število 
...
# =====================================================================@030229=
# 1. podnaloga
# Ugotovi kaj dela funkcija in jo pretvori v izpeljano tabelo.
# 
#        import random 
#        def funkcija1(n, a, b):
#            tab = []
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMDIyOSwidXNlciI6NjQ4M30:1nk1Ez:ZjGje2zUEK6a32oi0_UEPvGCX8w'
        try:
            random.seed(42)
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjozMDIzMCwidXNlciI6NjQ4M30:1nk1Ez:Ga3556gCysZ_jP49ptn3UX6dsws'
        try:
            s = Check.current_part['solution']
