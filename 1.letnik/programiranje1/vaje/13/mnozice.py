...
def mnozica(el1, el2, el3):
    """vrne mnozico elementov el1, el2, el3"""
    return {el1, el2, el3}
# =====================================================================@028365=
# 2. podnaloga
...
# =============================================================================
def mnozica2(sez):
    """vrne mnozico elementov seznama sez"""
    return set(sez)
# =====================================================================@028366=
# 3. podnaloga
...
def spremeni(mn, el1, el2):
    """vrne mnozico, ki ji doda el1 in odvzame el2"""
    mn.add(el1)
    mn.discard(el2)
    return mn
# =====================================================================@028367=
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2NDgzLCJwYXJ0IjoyODM2NH0:1n7FKI:ocxstxpCeWOebvQbz2F9kirA-QA'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2NDgzLCJwYXJ0IjoyODM2NX0:1n7FKI:RkbxlzMFjSYGDy7eDtws-cS1Pio'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2NDgzLCJwYXJ0IjoyODM2Nn0:1n7FKI:ZRDAmPaHria78LfUgGI3l4vhLD8'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2NDgzLCJwYXJ0IjoyODM2N30:1n7FKI:x_eAYXzas2QCFZp0CevFSjIKs7I'
        try:
