...
# med `a` in `b`. Če niza nista enakih dožin, naj funkcija vrne `None`.
# Na primer:
# 
...
def hammingova_razdalja(a, b):
    """vrne stevilo pozicij, v katerih se razlikujeta"""
    if len(a) != len(b):
        return None
    enke = 0
    for znak in a:
...
# =============================================================================
def je_medianska(s):
    """vrne True, ce je tabela medianska in False drugace"""
    for x, y, z in zip(s[0],s[1],s[2]):
        if mediana(x, y, z) not in s:
            return False
    return True
# =====================================================================@028324=
# 4. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2NDgzLCJwYXJ0IjoyODMyMX0:1n1ny7:2a7OB-0SpxHKFqKiCqo8tqPupls'
        try:
            ...
            tests = [
                ...
                ("hammingova_razdalja('11100000', '00011')", None)
            ]
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2NDgzLCJwYXJ0IjoyODMyMn0:1n1ny7:Y57tkpsA3EkXVBralQOdehlAOD0'
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2NDgzLCJwYXJ0IjoyODMyM30:1n1ny7:3aS0ekzZka9UdUAMTlqRKTy8Rag'
        try:
            tests = [
                ("je_medianska(['111','110','100','000'])", True),
                ("je_medianska(['000','110','100','111'])", True),
                ("je_medianska(['000','100','110','111'])", True),
                ("je_medianska(['111','110','100','001'])", False),
                ("je_medianska(['111','010','100','001'])", False),
                ("je_medianska(['011','110','100','001'])", True),
                ("je_medianska(['011','110','000','001'])", False),    
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2NDgzLCJwYXJ0IjoyODMyNH0:1n1ny7:AdrLv2FWEsYtrVf6DgvLdKUMoqo'
        try:
