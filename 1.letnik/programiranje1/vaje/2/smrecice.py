...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2NDgzLCJwYXJ0IjoyODA1N30:1mxbrV:pMcCjLzFc3OzeVJyHcJqRMxZPoM'
        try:
            def izpis(source):
                import io, sys
                old_stdout = sys.stdout
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2NDgzLCJwYXJ0IjoyODA1OH0:1mxbrV:9Xi1vlAxrgp-rhR7Xu1MOVYOI1A'
        try:
            def izpis(source):
                import io, sys
                old_stdout = sys.stdout
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2NDgzLCJwYXJ0IjoyODA1OX0:1mxbrV:Ke3xK2ZEhYhCLmck7RMmDRtzzsY'
        try:
            def izpis(source):
                import io, sys
                old_stdout = sys.stdout
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2NDgzLCJwYXJ0IjoyODA2MH0:1mxbrV:0j0bFlg-H81Is2sF0wcEQfpGxE4'
        try:
            def izpis(source):
                import io, sys
                old_stdout = sys.stdout
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2NDgzLCJwYXJ0IjoyODA2MX0:1mxbrV:6bzB5hEJyc4CaSGaz7Ye2O1lG_Y'
        try:
            def izpis(source):
                import io, sys
                old_stdout = sys.stdout
