...
# regija B. Zunanje stene te škatlice so polprepustne, kar pomeni, da bakterije
# lahko uidejo ven, vendar se ne morejo vrniti v škatlico, pregrada pa je
# prepustna, tj. bakterije lahko prehajajo v obe smeri. Bine predvideva, da v
# neki časovni enoti 12 % vseh bakterij ostane v svoji regiji, po 22 % pa jih
# zapusti svojo regijo v vsaki od štirih smeri. 
# Binetu sestavi program, ki bo prebral začetni masi bakterij (bakterije so premajhne,
# da bi jih šteli posamično, zato jih "štejemo" kar v gramih) v vsaki od regij
# in izpisal število korakov, dokler *skupna* masa bakterij v obeh regijah ne pade pod 0.001
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2NDgzLCJwYXJ0IjoyODE3M30:1mxbvM:WOUAyShhwQyRAEFUh0wrHD4MnEA'
        try:
            vh = [['22.4', '13.5'], ['10', '12'], ['0', '0'], ['0.001', '0.001'],
                  ['0.001', '0.0001'], ['0.0003', '0.0003'], ['0.00055', '0.00055'],
                  ['0.00045', '0.00065'], ['5.5', '10.5'], ['1.5', '0.5'],
                  ['23', '122'], ['23', '522'], ['1111', '12522'], ['1111', '42']]
            izh = [10, 10, 0, 1, 1, 0, 1, 1, 9, 8, 12, 13, 16, 13]
            
            for i in range(len(vh)):
                with Check.input(vh[i]):
                    if not Check.output(Check.current_part['solution'], [
                        'Masa v regiji A: ' + vh[i][0],
