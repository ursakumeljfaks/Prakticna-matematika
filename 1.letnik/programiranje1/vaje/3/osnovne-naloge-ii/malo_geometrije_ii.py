...
# Malo geometrije II
#
# Pri nalogi Malo Geometrije smo knjižnico `math` uvozili
# 
#       from math import *
# 
# Rekli pa smo, da je bolje, da uporabljamo
# 
#       import math
# 
# Zato naloge reši ponovno in uporabi `import math`. Pazi pa, ker so se določila glede tipov
# vhodnih podatkov malo spremenila!
# =====================================================================@028097=
# 1. podnaloga
# Napiši program, ki mu uporabnik poda polmer kroga v obliki decimalnega števila,
# in izpiše njegov obseg in površino. Obseg in ploščina naj bosta zaokrožena na dve decimalni mesti.
# 
# Pri zaokroževanju si pomagaj s funkcijo `round(stevilo, [st. stevk])`.
# Konstanta $\pi$ se nahaja v spremenljivki z imenom `math.pi`, potem ko smo uvozili knjižnico `math`,
...
# =====================================================================@028098=
# 2. podnaloga
# Spodnji program bi moral izračunati dolžino hipotenuze po Pitagorevem izreku, vendar se je pri programiranju zalomilo.
# 
...
# 
# Namig: če imaš težave z računanjem hipotenuze, preveri kaj v pythonu pomeni operator `^` in kako se računa potence:
...
# =====================================================================@028099=
# 3. podnaloga
# Napiši program, ki uporabnika vpraša po *celoštevilskih dolžinah* stranic poljubnega trikotnika
# in izpiše njegovo ploščino (zaokroženo na dve decimalki). Za izračun lahko uporabiš
# [Heronovo formulo](https://en.wikipedia.org/wiki/Heron%27s_formula).
# 
#     >>> Dolžina stranice a: 3
#     >>> Dolžina stranice b: 4
#     >>> Dolžina stranice c: 5
...
s = (a + b + c) / 2
ploscina = round(math.sqrt(s * (s - a) * (s - b) * (s - c)), 2)
print("Površina trikotnika:", ploscina)
# =====================================================================@028100=
# 4. podnaloga
# Zanima nas, kakšna je ploščina včrtanega kroga za trikotnik iz tretje podnaloge.
...
ploscina = round(math.sqrt(s * (s - a) * (s - b) * (s - c)), 2)
r = ploscina / s
ploscina_vcrtanega_kroga = round(math.pi * (r ** 2), 2)
print("Ploščina trikotniku včrtanega kroga:", ploscina_vcrtanega_kroga)
# =====================================================================@028101=
# 5. podnaloga
# Zanima nas, kakšna je ploščina očrtanega kroga za trikotnik iz tretje podnaloge.
...
r = (a * b * c) / (4 * ploscina)
ploscina_ocrtanega_kroga = round(math.pi * (r ** 2), 2)
print("Ploščina trikotniku očrtanega kroga:", ploscina_ocrtanega_kroga)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2NDgzLCJwYXJ0IjoyODA5N30:1mxbsY:uM8prKesTGrqWkIGWMOip9_t7ug'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2NDgzLCJwYXJ0IjoyODA5OH0:1mxbsY:S6ePrheBIV1hgKBoulclzXV6zes'
        try:
            vhod = [['3', '4'], ['1', '1'], ['10.3', '23.1']]
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2NDgzLCJwYXJ0IjoyODA5OX0:1mxbsY:A5m1YU6vTpfrlIhVTjSxfjW99kg'
        try:
            test = [['3', '4', '5', '6.0'], ['2', '5', '6', '4.68']]
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2NDgzLCJwYXJ0IjoyODEwMH0:1mxbsY:KKpOFr-EMbjqjl42ylOSedt1uMQ'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2NDgzLCJwYXJ0IjoyODEwMX0:1mxbsY:B9I8lBIdhEI3sKfVRcb_o6owt5g'
        try:
            test = [['3', '4', '5', '19.63'], ['2', '5', '6', '32.22'], ['1', '1', '1', '1.05']]
