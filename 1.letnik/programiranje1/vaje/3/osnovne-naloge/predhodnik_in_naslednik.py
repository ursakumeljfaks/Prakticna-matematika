...
predhodnik = vneseno_stevilo - 1
naslednik = vneseno_stevilo + 1
print("Število je:", vneseno_stevilo, "\nPredhodnik števila je:", predhodnik, "\nNaslednik števila je:", naslednik)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2NDgzLCJwYXJ0IjoyOTYzMn0:1mxbsN:VAW94q5eUITNAf0SgYbJk9SUjIo'
        try:
            with Check.input(['10']):
