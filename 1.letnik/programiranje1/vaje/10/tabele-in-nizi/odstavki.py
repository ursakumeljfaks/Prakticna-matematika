...
# vrstic nadomesti z eno samo prazno vrstico. Za prazne vrstice štejemo le tiste
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo2NDgzLCJwYXJ0IjoyODMwNX0:1mxsD3:2N_6juuKSK9guszG_GuS4QCx53E'
        try:
            (
                Check.secret(odstavki('Na padli bonbon\n\nnežno kaplja dež\n\nin ga topi...'),
                             "Kaj se zgodi z zadnjo vrstico?") and
                Check.equal("odstavki('V nekem mestu, v neki hiši\n"
                            ...
                            + 'ki pozna vse šale\nin je zmeraj nasmejan.\n\n'
                            + 'To je Piki, naš prijatelj,\ns polno torbico norčij.\n'
                            + 'Gremo z njim v medvedjo šolo\nse zabavat tudi mi.') and
                Check.equal("odstavki('Danes je lepo, sončno vreme.\n\n\n\nZunaj pojejo ptički.')",
                            'Danes je lepo, sončno vreme.\n\nZunaj pojejo ptički.') and
                Check.equal("odstavki('Drugi obrazi,\n\n\na še vedno isti\n \nokus kave.')",
                            'Drugi obrazi,\n\na še vedno isti\n \nokus kave.')
            )
        except:
